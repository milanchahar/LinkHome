                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-24">
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-[10px] font-black tracking-[0.3em] uppercase text-black/60">Excellence</span>
                        </div>
                        <h2 className="text-4xl md:text-7xl font-display font-black uppercase tracking-tighter">
                            Core <span className="font-serif-accent italic font-light text-zinc-800 normal-case tracking-normal">Signature</span> <br />
                            Features.
                        </h2>
                    </div>
                    <p className="text-zinc-800 max-w-sm font-medium leading-relaxed">
                        Every aspect of LinkHome is engineered for perfection, ensuring your search for
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    {featureList.map((feature, i) => (
                        ...
                        >
                            ...
                            <h3 className="text-[11px] font-black uppercase tracking-[0.2em] mb-4 text-black underline decoration-black/20 underline-offset-4">{feature.title}</h3>
                            <p className="text-zinc-800 leading-relaxed text-sm font-medium">
                                {feature.desc}
                            </p>
                        </motion.div>
                    ))}
